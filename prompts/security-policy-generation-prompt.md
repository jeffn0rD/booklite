# Security and Authentication Policy Generation Prompt
...
Condense these specifications into a compact summary with all the information that will be needed to design a comprehensive security and authentication specification:
(With these user roles: User, Admin)
...
6. Compliance Considerations/Requirements

You can append the next prompt for actual policy generation as well.